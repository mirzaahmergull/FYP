...
import ci from "./static/imgs/ci.png";
import e from "./static/imgs/e.png";
import gs from "./static/imgs/gs.png";
import h from "./static/imgs/h.png";
import j from "./static/imgs/j.png";
...
const ScMenu = () => {
  return (
    <ScrollMenu arrowLeft="false" arrowRight="false" wheel="true">
      ...
      <Link to="/VendorCards" style={{ textDecoration: "none" }}>
        <img
          alt="logo"
          src={ci}
          width="90"
      ...
      <Link to="/VendorEntertainment" style={{ textDecoration: "none" }}>
        <img
          alt="logo"
          src={e}
          width="90"
      ...
      <Link to="/VendorJwellery" style={{ textDecoration: "none" }}>
        <img
          alt="logo"
          src={j}
          width="90"

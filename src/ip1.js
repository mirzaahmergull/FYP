...
import mi from './im.png'
import Col from 'react-bootstrap/Col';
import Galleryim from './imgallery.js';
import r from './review.png'
    ...
    return ( 
        ...
        <div style={{marginTop: "50px", marginBottom: "50px"}}>
            ...
            <h4>Starting price: NA</h4>
             <Link to="/Login"><Button variant="info">View Location</Button></Link>{' '}
             <Link to="/Login"><Button variant="info">Send Inquiry</Button></Link>{' '}
             <Link to="/Login"><Button variant="warning">View Contact and Email</Button></Link>{' '}
        ...
        <div style={{marginTop: "50px", marginBottom: "50px"}}>
            ...
            <Galleryim />
            <p>Travel & Culture Services is one of the best Honeymoon in Karachi. If you are looking for the best Honeymoon in Karachi and you like the work of Travel & Culture Services then send an inquiry now and we will connect you with Travel & Culture Services as soon as possibe.


Travel & Culture Services is Tour-operator and Travel agent, licensed by the Ministry of Tourism Government of Pakistan to operate culture tours, adventure tours and trekking in Pakistan, for foreigners and Pakistanis. Our License Number is 2580</p>
        </div>
        <Link to="/Login"><img
                    alt="logo"
                    src={r}

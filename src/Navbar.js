...
import personlogo from './person-fill.svg'
    ...
    return (  
        ...
        <Container>
            <Navbar.Brand href="#home">
                <Link to='/' style={{ textDecoration: 'none', color: 'black'}}><img
                alt=""
            ...
            <Nav className="ms-auto">
                ...
                <Nav.Link  href="/RealWeddings">REAL WEDDINGS</Nav.Link>
                <Nav.Link href="#home">
                    <img
                    alt=""
                ...
                <Nav.Link  onClick={() => setModalShow(true)}><img
                    alt="logo"
                    src={personlogo}
                    width="30"
                    height="30"

...
{' '}
  ...
  <Card style={{border:"none"}} >
    <Card.Img style={{width:"100%", height:"100%"}} variant="top" src="https://i.edition.pk/large/2021/01/5ff2e25c67ba7.jpg" />
    <Card.Body style={{backgroundColor: "rgb(162, 212, 242)"}}>
      <Link to="/Sanam" style={{ textDecoration: 'none'}}><Card.Title>Sanam Baloch & Qassam Jafri</Card.Title></Link>
      <Card.Text>
        Lahore
      </Card.Text>
    </Card.Body>
...
export default SimilarWeddings3;
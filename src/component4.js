...
const Slides = () => {
    return ( 
      ...
      <Row lg="auto">
<Col>
        <Carousel fade style={{width: "400px", height: "350px", margin: "auto"}}>
...
<Col>
<Carousel fade style={{width: "350px", height: "350px", margin: "auto"}}>
  <Carousel.Item interval={1000}>
    <img
      className="d-block w-100 setimgsize1"
...
<Col>
<Carousel fade style={{width: "693px", height: "350px", margin: "auto"}}>
  <Carousel.Item interval={1000}>
    <img
      className="d-block w-100 setimgsize1"
...
<Col>
<Carousel fade style={{width: "480px", height: "320px", margin: "auto"}}>
  <Carousel.Item>
    <Link to='/RealWeddings' style={{ textDecoration: 'none', color: 'darkgray'}}><img
      className="d-block w-100 setimgsize1"

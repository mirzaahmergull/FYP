...
const RealWeddings = () => {
    return ( 
        ...
        <p>We love couples and their unique stories - How they met and how they went about planning their big day! These are the best way to understand a vendor’s work. You can also read more about these weddings on the shadiwelcome Blog.</p>
        {' '}
        &nbsp;
        ...
        <div className="checkalign" style={{marginLeft: "300px", marginTop: "50px"}}>
        <Container>
...
<Link to="/Sanam" style={{ textDecoration: 'none'}}><h3 style={{color:"rgb(162, 212, 242)"}}>Sanam Baloch & Qassam Jafri</h3></Link>
...
<Link to="/Fatima" style={{ textDecoration: 'none'}}><h3 style={{color:"rgb(162, 212, 242)"}}>Kanwar Arsalan & Fatima Effendi</h3></Link>
<div style={{ borderTop: "2px solid #fff ", marginLeft: 20, marginRight: 20,color: "rgb(149, 150, 150)" }}>___________________________________________________________</div>
{' '}
        &nbsp;
        {' '}
...
<Link to="/Aiza" style={{ textDecoration: 'none'}}><h3 style={{color:"rgb(162, 212, 242)"}}>Kashif Qadri & Aiza Taimoor</h3></Link>
<div style={{ borderTop: "2px solid #fff ", marginLeft: 20, marginRight: 20,color: "rgb(149, 150, 150)" }}>___________________________________________________________</div>
</Col>
&#160;
&#160;
...
<Link to="/Farhan" style={{ textDecoration: 'none'}}><h3 style={{color:"rgb(162, 212, 242)"}}>Farhan Saeed & Urwa Hocane</h3></Link>
<div style={{ borderTop: "2px solid #fff ", marginLeft: 20, marginRight: 20,color: "rgb(149, 150, 150)" }}>___________________________________________________________</div>
</Col>
</Row>
    </Container>
